              ...
              <div class="container">
                <div class="main-about-description">
                  ...
                  <div class="main-about-description-p">
                    <p>私は上海で生まれ、香港と日本で育ちました。 将来はIT系の会社で仕事をしたいと思い、立命館大学情報理工学部で勉強しています。</p>
                    <p>現在は基本情報技術者・TOEICの勉強を頑張っているので応援お願いします! このページをスワイプすると私のことをもっと知れるので是非スワイプしてください！</p>
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="main-works-item">
              ...
              <div class="main-works-item-text">
                ...
                <p>近年、複合サービスという複数のサービスを組み合わせて新しいサービスを作成する技術が発達し、サービス開発技術を迅速かつ柔軟にすることが可能になった。しかしながら、複合サービスの1部でも何らかの理由により使用不可になると、複合サービス全体に影響を及ぼすことがわかっている。これを補うために、正確な代替えサービスを迅速に発見する手法を探っていく。</p>
              </div>
            </div>
            ...
            <div class="main-works-item">
              ...
              <div class="main-works-item-text">
                ...
                <p>既存研究ではk-means法を用いたクラスタリング手法を採用していた。しかし、k-means法は各ノード(点)に1つのカテゴリしか割り当てることができず、複数のカテゴリに属す可能性があるノードも1つにまとめられてしまっていた。このことから,各ノードが確立に基づき、複数のカテゴリに割り当て可能であるソフトクラスタリングを採用し、研究していく。</p>
              </div>
            </div>
